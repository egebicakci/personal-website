  ...
  return (
    <>
      ...
      {mounted && isOpen
        ? createPortal(
            <div
              className="fixed inset-0 z-[130] bg-black/84 p-0 sm:flex sm:items-center sm:justify-center sm:p-6"
              onClick={closeModal}
            >
              <div
                className="glass-panel soft-outline relative flex h-[100dvh] w-full flex-col gap-4 overflow-hidden rounded-none px-3 pb-3 pt-4 sm:h-auto sm:max-h-[92vh] sm:max-w-6xl sm:gap-5 sm:rounded-[30px] sm:p-6"
                    ...
                    <div className="relative min-h-0 flex-1 overflow-hidden rounded-[24px] border border-white/10 bg-black/45">
                      {hasPrevious ? (
                        <button
                          ...
                          className="glow-hover absolute left-3 top-1/2 z-10 inline-flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-white/10 bg-black/60 text-white/85 transition hover:text-white sm:left-4"
                      ...
                      {hasNext ? (
                        <button
                          type="button"
                          onClick={() => setActiveImageIndex((current) => current + 1)}
                          className="glow-hover absolute right-3 top-1/2 z-10 inline-flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-white/10 bg-black/60 text-white/85 transition hover:text-white sm:right-4"
                      ...
                      <div className="flex h-[72dvh] w-full items-center justify-center p-2 sm:h-[56vh] sm:p-3">
                        <Image
                          ...
                          sizes="(max-width: 640px) 100vw, (max-width: 1280px) 100vw, 1100px"
                        />
                      </div>
                    </div>
                  </div>
